    ...
    <section className='max-w-7xl mx-auto'>
      <div>
            ...
            <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
                Create a stunning and beautiful collection of images with DALL-E
            </p>
        </div>
        ...
        <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
          <div className='flex flex-col gap-5'>
            <FormField labelName="Your name" type="text" 
              name="name" placeholder="John Doe" value={form.name} handleChange={handleChange} />
            
            <FormField labelName="Prompt" type="text" 
              name="prompt" placeholder='A comic book cover of a superhero wearing headphones' value={form.prompt} handleChange={handleChange} isSurpriseMe handleSurpriseMe={handleSurpriseMe} />
